...
<x-app-layout>
    <div class="max-w-4xl mx-auto mt-8">
        ...
        <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 md:p-8">
            <form x-data='{ 
            ...
            }' @submit="isSubmitting = true" action="{{ route('orders.store') }}" method="POST" enctype="multipart/form-data" class="space-y-8">
                @csrf
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div class="md:col-span-2">
                                    ...
                                    <div x-show="arr.arrangement_type === 'personalizado'" x-collapse>
                                        <input type="file" :name="'arrangements['+index+'][reference_image]'" accept=".jpg,.jpeg,.png,.pdf" :required="arr.arrangement_type === 'personalizado'" class="w-full border border-gray-200 rounded-lg px-4 py-2 focus:ring-[#4A1525] focus:border-[#4A1525] file:mr-4 file:py-2 file:px-4 file:rounded-full file:border-0 file:text-sm file:font-semibold file:bg-gray-100 file:text-[#4A1525] hover:file:bg-gray-200">
                ...
                <div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div class="md:col-span-2">
                            ...
                            <textarea name="delivery_references" rows="2" class="w-full border border-gray-200 rounded-lg px-4 py-2 mb-3 focus:ring-[#4A1525] focus:border-[#4A1525]" placeholder="Ej. Casa blanca con portón negro, frente al parque. O pega aquí el link de Maps."></textarea>
                ...
                <div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        @else
                            <div>
                                <label class="block text-sm font-medium text-gray-700 mb-2">Precio de Venta (MX$)</label>
                                <input type="number" step="0.01" min="0" name="unit_price" class="w-full border border-gray-200 rounded-lg px-4 py-2 focus:ring-[#4A1525] focus:border-[#4A1525]" placeholder="0.00" value="{{ old('unit_price') }}">
                            </div>
                            <div>
                                <label class="block text-sm font-medium text-gray-700 mb-2">Gastos de Envío (MX$)</label>
                                <input type="number" step="0.01" min="0" name="shipping_cost" class="w-full border border-gray-200 rounded-lg px-4 py-2 focus:ring-[#4A1525] focus:border-[#4A1525]" placeholder="0.00" value="{{ old('shipping_cost') }}">
                            </div>
                            <div>
                ...
                <div class="mt-8 flex justify-end gap-3 pt-6 border-t border-gray-100">
                    ...
                    <button type="submit" :disabled="isSubmitting" :class="isSubmitting ? 'opacity-70 cursor-not-allowed' : ''" class="bg-[#4A1525] hover:bg-[#340f1a] text-white px-8 py-2 rounded-lg transition-colors font-medium shadow-sm flex items-center justify-center min-w-[180px]">
                        <span x-show="!isSubmitting">Registrar Pedido</span>
