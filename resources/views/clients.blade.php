    ...
    <div class="bg-white md:bg-transparent rounded-2xl md:rounded-none shadow-sm md:shadow-none border border-gray-100 md:border-none overflow-hidden mb-20 md:mb-0">
        <div class="p-5 md:p-0 border-b border-gray-100 md:border-none flex flex-col md:flex-row md:items-center justify-between gap-4 mb-4">
            ...
            <div class="relative w-full md:w-[280px]">
                <input type="text" placeholder="Buscar por nombre, correo o empresa..." class="pl-10 pr-4 py-2 border border-[#EBEBEB] rounded-md text-[13px] text-gray-500 w-full focus:ring-[#4A1525] focus:border-[#4A1525] bg-transparent">
                ...
                <tbody class="divide-y divide-[#EBEBEB]">
                    ...
                    <tr class="hover:bg-white/50 transition-colors">
                        <td class="py-5 px-2 text-[13px] font-medium text-[#2C211A] flex items-center">
                            <div class="w-8 h-8 rounded-lg bg-[#FAFAFA] text-[#4A1525] flex items-center justify-center font-bold mr-3">LM</div>
                            Laura Mendoza
                        </td>
                        ...
                        <td class="py-5 px-2 text-center">
                            <button class="text-[#4A1525] hover:text-[#4A1525]"><svg class="w-6 h-6 mx-auto" fill="currentColor" viewBox="0 0 20 20"><path d="M6 10a2 2 0 11-4 0 2 2 0 014 0zM12 10a2 2 0 11-4 0 2 2 0 014 0zM16 12a2 2 0 100-4 2 2 0 000 4z"></path></svg></button>
                        </td>
                    </tr>
                    <tr class="hover:bg-white/50 transition-colors">
                        <td class="py-5 px-2 text-[13px] font-medium text-[#2C211A] flex items-center">
        ...
        <div class="md:hidden space-y-4 bg-[#F5F4F0] p-4">
            <div class="bg-white rounded-[14px] p-5 shadow-[0_2px_8px_rgba(0,0,0,0.04)] border border-[#EBEBEB]">
                <div class="flex items-center mb-3">
                    <div class="w-10 h-10 rounded-lg bg-[#FAFAFA] text-[#4A1525] flex items-center justify-center font-bold mr-3 text-lg">LM</div>
                    <div>
