...
class DatabaseSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        \App\Models\Order::create([
            ...
            'material' => 'Botella Térmica Acero',
            'quantity' => 122,
            'total_price' => 28800,
        ...
        \App\Models\Order::create([
            ...
            'company' => 'Kit Suculenta + Maceta',
            'material' => 'Kit Suculenta + Maceta',
            'quantity' => 30,
            'total_price' => 7200,
            'status' => 'Entregado',
        ...
        \App\Models\Order::create([
            ...
            'company' => 'Set Aromas Madera',
            'material' => 'Set Aromas Madera',
            'quantity' => 25,
            'total_price' => 6250,
            'status' => 'Cotizado',
